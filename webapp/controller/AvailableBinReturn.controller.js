sap.ui.define([
	...
	return Controller.extend("com.axium.Axium.controller.AvailableBinReturn", {
		...
		onAfterRendering: function () {
			...
			function cSuccess(data) {
				...
				oRef.getOwnerComponent().setModel(oModel, "AvailableBinReturn");
			}
